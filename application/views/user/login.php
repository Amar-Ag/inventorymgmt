    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-success">
                ...
                $logerror_msg= $this->session->flashdata('logerror_msg');
                ...
                <div class="panel-body">
                    ...
                    <center><b>You are not registered ?</b> <br></b><a href="<?php echo base_url('user/add'); ?>">Register here</a></center><!--for centered text-->
